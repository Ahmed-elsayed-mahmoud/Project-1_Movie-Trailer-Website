...
"""
This is the main file which will call the function that generates 
the website and pass the movies list as a parameter.
"""
...
avatar = media_movie.Movie("Avatar",
                     ...
                     "http://smellslikescreenspirit.com/wp-content/uploads/"
		     "2009/08/AvatarTeaserPoster-460x687.jpg",
...
seven_lucky_kids = media_movie.Movie("7 Lucky Kids",
                               "Seven kids with superior martial arts skills "
			       "stumble into excitement and adventure",
                               "http://ia.media-imdb.com/images/M/"
			       "MV5BMTI5MTg1NTIzOV5BMl5BanBnXkFtZTYw"
			       "NDg2Njg4._V1__SX640_SY720_.jpg",
...
in_a_world = media_movie.Movie("In a World",
			 ...
			 "/In_a_World_poster.jpg/220px-In_a_World_poster.jpg",
                         "https://www.youtube.com/watch?v=bZHBjLFu5is")

pi = media_movie.Movie("Pi",
                 "Story Line.",
                 "https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/"
		 "Piposter.jpg/220px-Piposter.jpg",
...
# Call the fresh_tomatoes to do its magic, 
#build the website and display the movies
